...
public class Teacher extends Person {
    ...
    public Teacher(int ID, String firstname, String lastname, String gender, String address, int department, int designation, int salary, int teachingHours) {
        ID = ID;
    ...
    public void addTeacher(InputTeachers())
    ...
    public Teacher InputTeachers() {
        ...
        return teachers = new Teacher(ID, firstName, lastName, gender, address, phonenumber, department, designation);
    }
